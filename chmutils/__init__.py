...
state_faces: Dict[str, Tuple[str, ...]] = {
    'winning': (
        ...
        '(*￣▽￣*)ブ', '♪(^∇^*)', '(oﾟvﾟ)ノ', '(/≧▽≦)/', '(((o(*ﾟ▽ﾟ*)o)))',
        '♪(´▽｀)', r'\(￣︶￣*\))', '||ヽ(*￣▽￣*)ノミ', '|Юo(*°▽°*)o',
        '(ﾉ◕ヮ◕)ﾉ*:･ﾟ', '✧(o゜▽゜)o☆', 'o(*￣▽￣*)oヽ', '(✿ﾟ▽ﾟ)ノ', 'b(￣▽￣)d',
        'o(^▽^)o', '(⌐■‿■)', '(★‿★)', '( ͡• ͜ʖ ͡• )', '( ͡° ͜ʖ ͡°)', '( ͡~ ͜ʖ ͡°)',
        '(￣▽￣)', '（︶♡︶）', '༼ つ ◕͜◕ ༽つ', r'\(^o^)/', '≧◡≦', '(＾▽＾)', '☆*:.｡.o(≧▽≦)o.｡.:*☆',
        '☀', '✩', r'\(^o^)/', r'\(^ω^\)', '(ﾉ^∇^)ﾉ', '(ﾉ^o^)ﾉ', '^o^', '^ω^', '^v^',
        '(≧◡≦)', '(◕‿◕)', '(◠‿◠✿)', '(✿◠‿◠)', '(＾▽＾)', '(⌒▽⌒)☆', '(★‿★)',
        '☆*:.｡.o(≧▽≦)o.｡.:*☆', '☀', '☁', '☂', '✩', '✪',
    ),
    ...
    'losing': (
        ...
        '(╯°□°）╯︵ ┻━┻┻━┻ ︵', '＼( °□° )／ ︵ ┻━┻', 'o(一︿一+)o', '(￣﹏￣；)',
        '(ㆆ_ㆆ)', '<(＿　＿)>', '.·´¯`(>▂<)´¯`·.', '⊙﹏⊙', '∥┗( T﹏T )┛', '༼ つ ◕︵◕ ༽つ',
        'orz', 'OTL', 'QAQ', 'T_T', 'Q_Q', ';_;', '._.',
        '(╥﹏╥)', '(ಥ﹏ಥ)', '(⋟﹏⋞)', '(╯︵╰,)', '(╯︵╰ )', '(╯_╰)', '(ಥ_ʖಥ)',
        '☁', '⚡', '⚡_⚡', '☂', '☁☁',
    ),

    'draw': (
        '^_^', r"¯\_(ツ)_/¯", '(¬_¬ )', '^_~', '^_____^', ':/', '+_+', '*_*', '=_=', '-_-',
        '⚆_⚆', '(⊙_◎)', '(●__●)', '◉_◉', '♨_♨', '←_←', '→_→', '<@_@>', '┑(￣Д ￣)┍',
        '(￣_,￣ )', '╮(╯-╰)╭', '……]((o_ _)彡', '☆ㄟ( ▔, ▔ )ㄏ', '(。_。)', '(>* - *<)',
        '(°°)～', '(‧‧)nnn≡', '[。。]≡', r'--\(˙<>˙)/--', '(ʘ ͟ʖ ʘ)', '( ͠° ͟ʖ ͡°)',
        r'¯\_( ͡° ͜ʖ ͡°)_/¯', r'¯\_(ツ)_/¯', '༼ つ ◕_◕ ༽つ',
        '(_　_)。゜zｚＺ', '(￣o￣) . z Z', 'ヾ(^▽^*)))', '(～﹃～)~zZ',
        '(・_・)', '(･_･)', '(¬､¬)', '(–_–)', '(━_━)', '-.-', '._.',
        '(´-ω-` )', '(―_―) zzZ', '(¬_¬ )', '(ʅ( ‾⊖◝)ʃ)',
        '─', '—', '…', '–', '➖',
